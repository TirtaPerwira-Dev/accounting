...
class JurnalPemakaianBahanDetailPolicy
{
     ...
     */
    public function view(User $user, JurnalPemakaianBahanDetail $jurnalPemakaianBahanDetail): bool
    {
     ...
     */
    public function update(User $user, JurnalPemakaianBahanDetail $jurnalPemakaianBahanDetail): bool
    {
     ...
     */
    public function delete(User $user, JurnalPemakaianBahanDetail $jurnalPemakaianBahanDetail): bool
    {
     ...
     */
    public function forceDelete(User $user, JurnalPemakaianBahanDetail $jurnalPemakaianBahanDetail): bool
    {
     ...
     */
    public function restore(User $user, JurnalPemakaianBahanDetail $jurnalPemakaianBahanDetail): bool
    {
     ...
     */
    public function replicate(User $user, JurnalPemakaianBahanDetail $jurnalPemakaianBahanDetail): bool
    {
