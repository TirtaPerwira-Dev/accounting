...
class JurnalRekeningAirDetailPolicy
{
     ...
     */
    public function view(User $user, JurnalRekeningAirDetail $jurnalRekeningAirDetail): bool
    {
     ...
     */
    public function update(User $user, JurnalRekeningAirDetail $jurnalRekeningAirDetail): bool
    {
     ...
     */
    public function delete(User $user, JurnalRekeningAirDetail $jurnalRekeningAirDetail): bool
    {
     ...
     */
    public function forceDelete(User $user, JurnalRekeningAirDetail $jurnalRekeningAirDetail): bool
    {
     ...
     */
    public function restore(User $user, JurnalRekeningAirDetail $jurnalRekeningAirDetail): bool
    {
     ...
     */
    public function replicate(User $user, JurnalRekeningAirDetail $jurnalRekeningAirDetail): bool
    {
