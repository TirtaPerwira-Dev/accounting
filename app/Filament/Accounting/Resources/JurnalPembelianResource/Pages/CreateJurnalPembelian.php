...
class CreateJurnalPembelian extends CreateRecord
{
    ...
    protected function handleRecordCreation(array $data): JurnalPembelian
    {
        ...
        // Ambil data dari item pertama untuk header (bukti & kode proyek)
        $firstItem = $pembelianItems[0] ?? null;
        ...
        $headerData = [
            ...
            'bukti' => $firstItem['bukti'] ?? null, // Set header bukti from first item
            'kode_proyek_id' => $firstItem['kode_proyek_id'] ?? null, // Set header kode_proyek from first item
