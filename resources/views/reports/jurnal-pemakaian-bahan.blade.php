...
<head>
    <meta charset="utf-8">
    <title>Laporan Jurnal Pemakaian Bahan (JPBIK)</title>
    <style>
        body {
...
<body>
    <div class="header">
        ...
        <div class="report-title">LAPORAN JURNAL PEMAKAIAN BAHAN (JPBIK)</div>
        <div class="period">
    ...
    <table>
        <thead>
            <tr>
                ...
                <th width="10%">Beban Bagian</th>
                <th width="12%">Rekening Debit</th>
                <th width="12%">Rekening Kredit</th>
                <th width="10%" class="text-right">Jumlah (Rp)</th>
        ...
        <tbody>
            ...
            @forelse($journals as $index => $journal)
                <tr>
                    ...
                    <td>{{ $journal->bukti }}</td>
                    <td>{{ $journal->beban_bagian }}</td>
                    <td>{{ $journal->rekeningDebit->nama_rek ?? '-' }}</td>
                    <td>{{ $journal->rekeningKredit->nama_rek ?? '-' }}</td>
