<x-filament-panels::page>
    <div class="prose dark:prose-invert max-w-none">
        ...
        <h4>Main Tables:</h4>
        <pre class="bg-gray-100 dark:bg-gray-900 p-4 rounded"><code>accounts (id, no_kel, no_rek, no_bantu, nama, kode, kel)
...
permissions (id, name, guard_name)</code></pre>

        <h3>Code Structure</h3>
        <pre class="bg-gray-100 dark:bg-gray-900 p-4 rounded"><code>app/
  ├── Filament/
  ...
  └── Traits/           # Reusable Traits</code></pre>

        <h3>Important Models</h3>
        <h4>JurnalRekeningAir.php</h4>
        <pre class="bg-gray-100 dark:bg-gray-900 p-4 rounded text-sm"><code>use HasFactory, SoftDeletes, LogsActivity;
...
protected static function boot() {
    ...
    static::creating(function ($model) {
        ...
        <pre class="bg-gray-100 dark:bg-gray-900 p-4 rounded text-sm"><code>// In model
use SoftDeletes;
...
$jurnal->restore();          // Restore</code></pre>

        <h4>2. Activity Logs</h4>
        <pre class="bg-gray-100 dark:bg-gray-900 p-4 rounded text-sm"><code>use LogsActivity;

protected static $logAttributes = ['*'];
protected static $logOnlyDirty = true;

// Auto logs: created, updated, deleted</code></pre>

        <h4>3. Auto created_by</h4>
        <pre class="bg-gray-100 dark:bg-gray-900 p-4 rounded text-sm"><code>static::creating(function ($model) {
    if (auth()->check()) {
        $model->created_by = auth()->id();
    }
});</code></pre>
        ...
        <pre class="bg-gray-100 dark:bg-gray-900 p-4 rounded text-sm"><code>try {
    ...
    Notification::make()
        ...
        <h3>Testing</h3>
        <pre class="bg-gray-100 dark:bg-gray-900 p-4 rounded text-sm"><code># Run all tests
php artisan test
